...
> Return the last visual character(s) of a string.
...
Returns the last visual character of a string.
...
If provided a second argument, the function returns the last `n` characters.

```javascript
var out = last( 'foo bar', 4 );
// returns ' bar'
...
str = last( 'The Last of the Mohicans', 4 );
// returns 'cans'
